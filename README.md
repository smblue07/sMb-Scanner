...
python scanner.py
    ...
    Paste your working base config link (e.g., vless://...).

    Choose your target CDN (Cloudflare, Gcore, Fastly, or Custom IPs).

    Wait for the scan to finish.

    View your Diamond links by typing: cat diamond_configs.txt

    Copy the generated links and paste them into v2rayN, v2rayNG, or V2Box!
...
۱. برنامه Termux را از F-Droid یا گیت‌هاب دانلود و نصب کنید. (⚠️ نسخه گوگل‌پلی خراب است، از آن استفاده نکنید).
